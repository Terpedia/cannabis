...
def test_validate_artifacts_enforces_carbon_partition_and_mapping_rows(tmp_path):
    ...
    assert result["valid"]
    assert result["checks"] == {"carbon_atom_partition": True, "atom_evidence_fields": True, "global_carbon_accounting": True, "reaction_product_carbon_rows": True, "reaction_mapping_classification": True, "no_imbalanced_reactions": True}
