...
def run():
    ...
    raw = Path('data/raw/chalcone-annotations')
    ...
    report = {'schema': 'cannabis-chalcone-annotation-context-v1', 'model_eligible': False, 'rows': rows,
    ...
    Path('data/reports/phase1-chalcone-annotations.json').write_text(json.dumps(report, separators=(',', ':')) + '\n')
