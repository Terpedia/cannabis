...
Terpedia snapshot, only 3 carbon nodes are reachable from the CO₂ seed through
2,590 inferred structural edges plus 1 candidate CO₂-transfer edge. There are
