...
- Additional reaction-product carbons are explicitly classified as **8,674
  candidate**, **8,440 ambiguous**, and **412 unresolved**; every product
...
It also reports `carbon_mapping_blockers`: 493 reactions and 8,852 product
...
reactions with unresolved or ambiguous product-carbon rows: 8,852 carbon
