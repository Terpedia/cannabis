...
- Additional reaction-product carbons are explicitly classified as **8,680
  candidate**, **8,440 ambiguous**, and **406 unresolved**; every product
...
It also reports `carbon_mapping_blockers`: 493 reactions and 8,846 product
...
reactions with unresolved or ambiguous product-carbon rows: 8,846 carbon
