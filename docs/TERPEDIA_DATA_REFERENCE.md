...
- Additional reaction-product carbons are explicitly classified as **16,789
  ambiguous** and **1,694 unresolved**; every product carbon has a mapping row.
...
summary from the RDKit report: 109 reactions are fully inferred, 417 retain
ambiguous carbon mappings, and 567 retain unresolved mappings. These statuses are
