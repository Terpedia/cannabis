...
- Structurally inferred reaction-product carbon mappings: **3,891** (**17.5365%**).
- Additional reaction-product carbons are explicitly classified as **16,628
...
reachable from the CO₂ seed through 2,895 inferred structural edges and
97,091 explicitly retained candidate alternative edges. Candidate alternatives
