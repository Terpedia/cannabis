...
- Additional reaction-product carbons are explicitly classified as **8,669
  candidate**, **8,465 ambiguous**, and **419 unresolved**; every product
...
- A separate snapshot of
  ...
  `data/terpedia/terpene-biohypothetical-connections-current-v2.json`. These
  remain separate from the 1,901-edge hypothesis layer until their identity
  namespace and reaction semantics are reconciled.
...
It also reports `carbon_mapping_blockers`: 494 reactions and 8,884 product
...
CannabisDB carbon atoms into **1 supported**, **1,381 candidate**, and
**284,241 unresolved** atoms. Each group retains CannabisDB atom indices,
