...
- Structurally inferred reaction-product carbon mappings: **5,745** (**25.51%**).
- Additional reaction-product carbons are explicitly classified as **115
  candidate**, **15,411 ambiguous**, and **1,251 unresolved**; every product
...
working network, 3,049 carbon atom nodes across the reachable metabolite
entities are reachable from the CO₂ seed through 4,558 inferred structural
edges and 87,398 explicitly retained candidate alternative edges. Candidate alternatives
...
direction records. There are 394 carbon-containing reactant entities outside
that lineage and therefore reported as external-carbon-source blockers. The
current target summary is 1 supported, 225 candidate, and 5,994 unresolved
CannabisDB compounds. The one supported target is the CannabisDB CO₂ record
itself; 225 candidate targets have exact or candidate identities with partial
...
summary from the RDKit report: 281 reactions are fully inferred, 12 retain
candidate mappings, 399 retain ambiguous carbon mappings, 407 retain
...
5,994 unresolved CO₂-lineage targets. TKS and OAC have dedicated coupled or
