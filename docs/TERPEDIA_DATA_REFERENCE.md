...
- Structurally inferred reaction-product carbon mappings: **3,803** (**17.1399%**).
- Additional reaction-product carbons are explicitly classified as **16,716
...
- CannabisDB-to-Terpedia identity crosswalk: **136 exact**, **1 ambiguous**,
  **6,082 CannabisDB compounds without an exact link**; 1,257 CannabisDB
  ...
  has 1,108 metabolites without a CannabisDB match.
...
reachable from the CO₂ seed through 2,809 inferred structural edges and
98,158 explicitly retained candidate alternative edges. Candidate alternatives
