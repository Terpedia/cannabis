...
- Terpedia reaction-product carbon atoms: **22,290**.
- Structurally inferred reaction-product carbon mappings: **3,906** (**17.5236%**).
- Additional reaction-product carbons are explicitly classified as **16,701
  ambiguous** and **1,682 unresolved**; every product carbon has a mapping row.
...
reachable from the CO₂ seed through 2,911 inferred structural edges and
97,437 explicitly retained candidate alternative edges. Candidate alternatives
...
1,250 working Terpedia metabolite records, 1,091 working biochemical reaction records,
...
Every one of the 1,091 working reaction records also carries a carbon-mapping
...
- 687 of 1,091 working reactions are fully element- and charge-balanced after the
