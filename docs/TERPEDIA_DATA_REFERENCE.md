...
- The completeness artifact now separately reports the expanded hypothesis
  layer: **7,249** directed edges (**6,184 candidate**, **1,065 unresolved**),
...
- The BigQuery table `terpedia-489015.terpedia_core.terpene_identity_set` was
  queried by full InChIKey. It contributed **245 exact identity-set matches**
...
17 provisional CannabisDB targets (387 carbon atoms); 1,065 unresolved edges
...
snapshot contains 245 such matches. This table is an identity resource, not
...
1,065 red unresolved-substrate edges backed by 544 unique carbon-containing
missing-substrate structures. Exact canonical RDKit structure matching resolved
100 previously anonymous substrate structures to existing corpus compounds;
