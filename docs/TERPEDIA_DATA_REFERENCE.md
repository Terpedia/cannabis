...
- Terpedia reaction-product carbon atoms: **22,202**.
- Structurally inferred reaction-product carbon mappings: **3,899** (**17.5615%**).
- Additional reaction-product carbons are explicitly classified as **16,634
  ambiguous** and **1,668 unresolved**; every product carbon has a mapping row.
...
rule. None currently has an exact Terpedia identity or reaction participation;
this is a documented curation gap, not an inference that the compounds are
absent from Cannabis or that they share one biosynthetic route.
...
Terpedia snapshot, 31 carbon atom nodes across 14 metabolite entities are
reachable from the CO₂ seed through 2,904 inferred structural edges and
97,107 explicitly retained candidate alternative edges. Candidate alternatives
...
direction records. There are 631 carbon-containing reactant entities outside
...
1,245 Terpedia metabolite records, 1,087 Terpedia biochemical reaction records,
...
Every one of the 1,087 reaction records also carries a carbon-mapping summary
from the RDKit report: 109 reactions are fully inferred, 416 retain ambiguous
