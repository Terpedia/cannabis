...
- Terpedia has **1,105** working reactions, including **8** explicitly
  non-enzymatic decarboxylations and **1,097** enzyme-requiring reactions.
- **11** enzyme-requiring reactions lack a direct enzyme association; **7** have
  attached candidate proteins and **4** remain without attached candidates.
- CannabisDB compounds: **6,220**.
- CannabisDB carbon atoms: **285,623**.
- Terpedia reaction-product carbon atoms: **22,642**.
- Structurally inferred reaction-product carbon mappings: **5,873** (**25.94%**).
...
entities are reachable from the CO₂ seed through 4,686 inferred structural
edges and 87,372 explicitly retained candidate alternative edges. Candidate alternatives
...
1,266 working Terpedia metabolite records, 1,105 working biochemical reaction records,
...
Every one of the 1,105 working reaction records also carries a carbon-mapping
summary from the RDKit report: 287 reactions are fully inferred, 12 retain
candidate mappings, 400 retain ambiguous carbon mappings, 406 retain
...
It also carries 2,249 candidate hypotheses and 4,063 deduplicated candidate
...
reaction set contains 2,257 records: 1,721 candidate records and 536 blocked
records; 1,340 are attached to a working reaction, including eight explicit
...
- 725 of 1,105 working reactions are fully element- and charge-balanced after
...
6,220 CannabisDB compounds (285,623 carbon atoms), all 1,105 reaction mapping
