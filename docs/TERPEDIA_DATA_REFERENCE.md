...
- CannabisDB-to-Terpedia identity crosswalk: **148 exact**, **1 ambiguous**,
  **6,072 without an exact identity**, and **5,781 without any identity
  resolution**; 1,507 CannabisDB carbon atoms are identity-linked. The
  reverse-direction Terpedia inventory has 1,112 metabolites without a
  ...
  ambiguous group. These alternatives may differ in stereochemistry,
  protonation, or tautomer state and are never treated as exact identity.
...
summary from the RDKit report: 119 reactions are fully inferred, 24 retain
