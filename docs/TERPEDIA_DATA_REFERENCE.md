...
- Terpedia reactions without enzyme associations: **7** of **1,093**.
...
- Terpedia reaction-product carbon atoms: **22,394**.
- Structurally inferred reaction-product carbon mappings: **3,910** (**17.46%**).
- Additional reaction-product carbons are explicitly classified as **186
  candidate**, **16,873 ambiguous**, and **1,425 unresolved**; every product
...
1,253 working Terpedia metabolite records, 1,093 working biochemical reaction records,
...
- 713 of 1,093 working reactions are fully element- and charge-balanced after
