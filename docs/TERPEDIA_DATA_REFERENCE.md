...
- Terpedia has **1,096** working reactions, including **3** explicitly
...
- Terpedia reaction-product carbon atoms: **22,460**.
- Structurally inferred reaction-product carbon mappings: **4,036** (**17.97%**).
...
- CannabisDB-to-Terpedia identity crosswalk: **136 exact**, **1 ambiguous**,
  **6,082 CannabisDB compounds without an exact link**; 1,257 CannabisDB
  ...
  candidate layer contains 249 one-to-one candidates and 40 ambiguous groups;
...
rule. None currently has an exact Terpedia identity; four records now have
explicit curated reaction participation through the CBGA oxidocyclization
...
working network, 2,843 carbon atom nodes across 17 metabolite entities are
reachable from the CO₂ seed through 2,916 inferred structural edges and
98,328 explicitly retained candidate alternative edges. Candidate alternatives
...
current target summary is 1 supported, 211 candidate, and 6,008 unresolved
...
CannabisDB carbon atoms into **1 supported**, **1,149 candidate**, and
**284,473 unresolved** atoms. Each group retains CannabisDB atom indices,
...
1,256 working Terpedia metabolite records, 1,096 working biochemical reaction records,
...
Every one of the 1,096 working reaction records also carries a carbon-mapping
...
unresolved mappings. These statuses are
...
6,008 unresolved CO₂-lineage targets. TKS and OAC have dedicated coupled or
...
- 716 of 1,096 working reactions are fully element- and charge-balanced after
