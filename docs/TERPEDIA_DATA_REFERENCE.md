...
- Terpedia reactions without enzyme associations: **153**.
- CannabisDB compounds: **6,220**.
- CannabisDB carbon atoms: **285,623**.
- Terpedia reaction-product carbon atoms: **22,268**.
- Structurally inferred reaction-product carbon mappings: **3,905** (**17.5364%**).
- Additional reaction-product carbons are explicitly classified as **16,678
  ambiguous** and **1,684 unresolved**; every product carbon has a mapping row.
...
working network, 31 carbon atom nodes across 14 metabolite entities are
reachable from the CO₂ seed through 2,910 inferred structural edges and
97,333 explicitly retained candidate alternative edges. Candidate alternatives
...
direction records. There are 632 carbon-containing reactant entities outside
...
1,249 Terpedia metabolite records, 1,090 working biochemical reaction records,
...
Every one of the 1,090 working reaction records also carries a carbon-mapping
summary from the RDKit report: 109 reactions are fully inferred, 416 retain
ambiguous carbon mappings, and 565 retain unresolved mappings. These statuses are
...
It also carries 2,240 candidate hypotheses and 4,046 deduplicated candidate
...
- 686 of 1,090 working reactions are fully element- and charge-balanced after the
