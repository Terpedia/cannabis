...
- Structurally inferred reaction-product carbon mappings: **3,550** (**15.9996%**).
- Additional reaction-product carbons are explicitly classified as **16,969
...
reachable from the CO₂ seed through 2,594 inferred structural edges and
100,032 explicitly retained candidate alternative edges. Candidate alternatives
...
current target summary is 0 supported, 0 candidate, and 6,220 unresolved
CannabisDB compounds. This indicates that the imported reaction network is
