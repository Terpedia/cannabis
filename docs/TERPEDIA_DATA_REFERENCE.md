...
- Structurally inferred reaction-product carbon mappings: **6,080** (**26.85%**).
- Additional reaction-product carbons are explicitly classified as **115
  candidate**, **15,283 ambiguous**, and **1,164 unresolved**; every product
...
working network, 3,066 carbon atom nodes across the reachable metabolite
entities are reachable from the CO₂ seed through 4,768 inferred structural
edges and 87,203 explicitly retained candidate alternative edges. Candidate alternatives
...
current target summary is 1 supported, 233 candidate, and 5,986 unresolved
CannabisDB compounds. The one supported target is the CannabisDB CO₂ record
itself; 233 candidate targets have exact or candidate identities with partial
...
candidate mappings, 396 retain ambiguous carbon mappings, 385 retain
...
5,986 unresolved CO₂-lineage targets. TKS and OAC have dedicated coupled or
