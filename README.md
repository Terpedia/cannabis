...
- `docs/data/networkdb.json` is the unified NetworkDB snapshot: all 6,220
  CannabisDB compounds, all 1,261 working Terpedia metabolite nodes, all 1,099
...
- `docs/data/testable-hypotheses.json` turns the unresolved queue and six
  source-linked non-enzymatic conversions into 2,249 falsifiable reaction
